...
public class UiTest {
    @Test
    public void showError_validReason_addsErrorPrefix() {
        Ui ui = new Ui(false);
    ...
    @Test
    public void showLoadingError_validReason_doesNotAddErrorPrefix() {
        Ui ui = new Ui(false);
    ...
    @Test
    public void showLoadingWarning_multipleWarnings_doesNotAddErrorPrefix() {
        Ui ui = new Ui(false);
