...
For every request to create, modify, refactor, or review Java production or test code, read and follow the project-specific
`.codex/skills/seedu-code-quality/SKILL.md` skill. It applies the CS2103/T code-quality practices for readability,
naming, safe shortcuts, and purposeful comments.
...
The skill includes the SE-EDU Javadoc requirements.

## Git

Use lightweight tags unless the user requests an annotated tag.
Before proposing or creating any commit, read and follow the project-specific
`.codex/skills/seedu-git-standard/SKILL.md` skill. This applies to every future commit in this project.
